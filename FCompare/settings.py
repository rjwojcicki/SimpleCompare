...
_COMPAISON_TOOL = "comparisonTool"
...
class Settings:
    ...
    def _ask_for_comaparison_tool(self):
        ...
        if viewer_path:
            ...
            self.settings[_COMPAISON_TOOL] = viewer_path
